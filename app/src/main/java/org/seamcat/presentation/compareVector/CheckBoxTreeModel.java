...
public class CheckBoxTreeModel extends DefaultTreeSelectionModel {

	private TreeModel model;

	public CheckBoxTreeModel(TreeModel model) {
		this.model = model;
   ...
   private void toggleRemoveSelection(TreePath path) {
	...
	public void addChildPaths(TreePath path, TreeModel model, List<TreePath> result){
	...
	public List<TreePath> getDescendants(TreePath paths[] , TreeModel model){
	...
	public List<TreePath> getAllCheckedPaths(CheckBoxTreeManager manager, JTree tree){
