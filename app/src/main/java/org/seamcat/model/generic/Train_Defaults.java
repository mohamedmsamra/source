...
public class Train_Defaults {
	...
	public static AntennaGain<HorizontalVerticalInput> defaultAntennaGain() {
        ...
        AntennaGainConfiguration<HorizontalVerticalInput> antenna = antennaGain().getHorizontalVerticalAntenna(build(prototype), 1000);
